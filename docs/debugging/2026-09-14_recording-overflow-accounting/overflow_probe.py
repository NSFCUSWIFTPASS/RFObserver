...
received = 0; gaps = 0; gap_events = 0; overflows = 0; no_ts = 0
...
rx.issue_stream_cmd(cmd)
span = round((next_t - first_t) * RATE)
print(f"rate={RATE/1e6:.1f}MS/s wall={wall:.2f}s chunks={chunks} overflows={overflows} "
      f"gap_events={gap_events} gap_samples={gaps} received={received} no_ts={no_ts}")
